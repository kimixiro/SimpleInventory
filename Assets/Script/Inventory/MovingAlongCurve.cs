...
public class MovingAlongCurve : MonoBehaviour
{
    ...
    public MovingAlongCurve StartMoving(Vector3 from, Vector3 to, Vector3 through, int duration)
    {
        _from = from;
        _to = to;
        _through = through;
    ...
    {
        float negativeT = 1f - t, aCoef = negativeT * negativeT, bCoef = 2 * t * negativeT, cCoef = t * t;
        
        return  new Vector3(a.x*aCoef+b.x*bCoef+c.x*cCoef,a.y*aCoef+b.y*bCoef+c.y*cCoef,a.z*aCoef+b.z*bCoef+c.z*cCoef);
    }
